...
const Title = () => (
  <div className="mb-5 mt-md-5 py-5">
    <div className="horizontal-container" style={ { paddingTop: '5rem' } }>
      <PageTitle title="Getting our design system off the ground" />
      <ProjectSummarySection
        title="Context" body={ [
        <div>Inconsistent UI across entire product.</div>,
        <div>Growing design team.</div>,
        <div>Engineering distrusted design.</div> ] } />
      <ProjectSummarySection
        title="Problem" body={["Sales was losing deals due to poor UI/UX"]} />
      <ProjectSummarySection
        title="Solution" body={ [
        "Make business case for design system for leadership buy-in",
        "Standardized patterns on design side",
        "Parity between components in Figma and in code" ] } />
      <div className="row">
        ...
        <div className="col-10 col-md-6">
          <p className="font-weight-regular">
            Established <font-weight-bold>design system team</font-weight-bold> across design,
      ...
      <div className="row mb-5">
        ...
        <div className="col-10 col-md-6">
          <p className="font-weight-regular">
            Standardize design patterns in Figma design system.
          </p>
          <p className="font-weight-regular">
            Enroll engineering to establish matching shared component library in code.
          </p>
        </div>
      </div>
      <div className="row">
        ...
        <div className="mt-md-5">
          ...
          <GroupHeader title="User journey mapping">
            <div className="row">
              <div className="col-md-6">
                <p>
                  After exposing this flaw in our installation flow, which was affecting so many of
                  our backups tool users, I wanted to make sure we were accounting for all possible
                  paths for backups purchases.
                </p>
                <p>
                  I found multiple ways that a user could fall into a state where they had purchased
                  backups support and yet remained unprotected due to inactivated licenses.
                </p>
              </div>
              <div className="col-md-6">
          ...
          <GroupHeader title="Aligning the product with our marketing">
            <div className="row">
              <div className="col-md-6 d-flex flex-column justify-content-between">
                <p>
                  Since 95% of purchases are made via the marketing site sign up flow, the wording
                  used there sets the expectation of how the tool works.
                </p>
                <p>
                  The feature "Automated Backups" implies that the tool works "automatically". Our
                  survey data proved that more users are not aware that further action is needed.
                </p>
              </div>
          ...
          <GroupHeader
            title="Auto-install licenses for new backups purchases"
            eyebrow="The solution">
            <div className="row">
              <div className="col-md-6 d-flex flex-column justify-content-between">
                <p>
                  I proposed our V1 solution should focus on CodeGuard users who have less than 6
                  sites, since that makes >99% of our users.
                </p>
                <p>
                  The feature "Automated Backups" implies that the tool works "automatically". Our
                  survey data proved that more users are not aware that further action is needed.
          ...
          >
            <div className="row">
              <div className="col-md-6">
                ...
                <p>
                  Understand the full context of the ask, so I know if and when it is appropriate to
                  push back.
                </p>
                <p>
