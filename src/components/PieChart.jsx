    ...
    return (
      <figure>
        <svg viewBox="0 0 63.6619772368 63.6619772368">
          ...
          <text className={`pie-label pie-label-1 ${this.state.loadLabels ? 'animate' : ''} ${this.state.hidePie1 ? 'hide' : ''}`} x="45" y="20">Journalism</text>
          ...
          <text className={`pie-label pie-label-2 ${this.state.loadLabels ? 'animate' : ''} ${this.state.hidePie2 ? 'hide' : ''}`} x="40" y="55">Inbound marketing</text>
          ...
          <text className={`pie-label pie-label-3 ${this.state.loadLabels ? 'animate' : ''} ${this.state.hidePie3 ? 'hide' : ''}`} x="5" y="62">Scrum/Agile</text>
          <text className={`pie-label pie-label-4 ${this.state.loadLabels ? 'animate' : ''} ${this.state.hidePie4 ? 'hide' : ''}`} x="-20" y="30">Product & Engineering</text>
        </svg>
